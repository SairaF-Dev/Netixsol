...
Investment goals are included in the interface for future business-rule scoring.
...
1. Payment plan for `DHA-APT-001`
...
* Skyline Residences amenities
* Skyline Residences developer
* Skyline Residences location
* Skyline Residences bedrooms
* Skyline Residences availability
* DHA Pearl Apartments price
